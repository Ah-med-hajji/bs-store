...
(function() {
  ...
  function injectNavbar() {
    ...
    var aboutHref = isCategoryPage ? prefix + 'index.html#about' : '#about';
    var contactHref = isCategoryPage ? prefix + 'index.html#contact' : '#contact';
    var shopHref = prefix + 'index.html#categories';
    var langLabel = getCurrentLang() === 'fr' ? 'EN' : 'FR';
    ...
    nav.innerHTML =
      '<div class="nav-container">' +
        ...
        '<ul class="nav-links" id="navLinks">' +
          ...
          '<li><a href="' + aboutHref + '" data-i18n="nav.about">A propos</a></li>' +
          '<li class="nav-dropdown">' +
            '<a href="' + shopHref + '" data-i18n="nav.shop" class="nav-dropdown-trigger">Boutique</a>' +
            ...
            '</ul>' +
          '</li>' +
          '<li><a href="' + contactHref + '" data-i18n="nav.contact">Contact</a></li>' +
        '</ul>' +
        '<div class="nav-actions">' +
          '<button class="nav-lang-toggle" id="langToggle" onclick="toggleLanguage()" aria-label="Toggle language">' + langLabel + '</button>' +
          '<button class="nav-cart-btn magnetic" data-strength="15" id="cartToggle" aria-label="Panier">' +
      ...
      '<div class="container">' +
        '<div class="footer-grid">' +
          '<div class="footer-col">' +
            ...
            '<p data-i18n="footer.brand_desc">Pr\u00eat-\u00e0-porter masculin premium, con\u00e7u pour l\'homme moderne. Qualit\u00e9 et style depuis 2024.</p>' +
          '</div>' +
          '<div class="footer-col">' +
        ...
        '<div class="footer-bottom">' +
          '<p>&copy; 2024 BS Store. <span data-i18n="footer.rights">Tous droits r\u00e9serv\u00e9s.</span></p>' +
        '</div>' +
      '</div>' +
    '</footer>';
  }
  ...
  function injectOrderFormOverlay() {
    ...
    var govOptions = '<option value="" data-i18n="form.governorate_default">S\u00e9lectionnez votre gouvernorat</option>';
    ...
    '<div class="order-form-overlay" id="orderFormOverlay">' +
      '<div class="order-form">' +
        '<div class="order-form-header">' +
          ...
          '<button class="order-form-close" id="orderFormClose" aria-label="Fermer">' +
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="20" height="20">' +
              '<path d="M18 6L6 18M6 6l12 12"/>' +
            '</svg>' +
          '</button>' +
        ...
        '<form id="orderForm" novalidate>' +
          ...
          '</div>' +
          '<div class="form-group">' +
            '<label for="orderPhone" data-i18n="form.phone">Num\u00e9ro de T\u00e9l\u00e9phone</label>' +
          ...
          '<div class="form-group">' +
            ...
            '<textarea id="orderAddress" rows="2" data-i18n-attr="placeholder:form.address_placeholder" placeholder="Entrez votre adresse compl\u00e8te" required></textarea>' +
          ...
          '<div class="order-summary-section">' +
            '<h4 data-i18n="form.order_summary">R\u00e9sum\u00e9 de la Commande</h4>' +
